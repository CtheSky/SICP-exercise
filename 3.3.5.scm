...
(define (divider d1 d2 quotient)
  (define (process-new-value)
    (cond ((or (and (has-value? d2) (= 0 (get-value d2)))
	      (and (has-value? quotient) (= 0 (get-value quotient))))
	   (error "dividend is 0 -- DIVIDER"))
...
;;instance of celsius-fahreheit-converter c f
